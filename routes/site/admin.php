...
Route::middleware(['auth'])->group(function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::prefix('contact_mail')->group(function () {
            ...
            Route::get('/view/{id}', [ContactUsMailController::class, 'view'])->name('contact_mail.view');
        });
        ...
        Route::prefix('settings')->group(function () {
            ...
            Route::post('/company-update', [SettingController::class, 'companyUpdate'])->name('settings.company.update');
            ...
            Route::post('/custom-code-update', [SettingController::class, 'customCodeUpdate'])->name('settings.custom.code.update');
