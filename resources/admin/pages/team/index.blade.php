            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-header">Teams ({{ $items->total() }})</h5>
                            ...
                            <tbody class="table-border-bottom-0">
                                @forelse($items as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="avatar-wrapper">
                                                <div class="avatar me-2">
                                                    <img src="{{ asset($item->photo) }}" alt="Service Image">
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{ $item->name }}</td>
                                        ...
                                        <td>
                                            <span class="d-flex">
                                                <a href="{{ route('team.edit', ['id' => $item->id]) }}" class="me-4"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteForm" action="{{ route('team.delete', ['id' => 0]) }}" method="POST">
                        @csrf
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteLinks.forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    form.action = '{{ route('team.delete', ['id' => '']) }}/' + itemId;
                });
            });
        });
    </script>
