...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset($systemFavicon->file)}}">
...
<body>
    ...
    <div class="main">
        <h1>419</h1>
        <p>It looks like logged in but access to requested area is forbidden<br />That's a trouble?</p>
